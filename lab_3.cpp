...
auto main() -> int {
    ...
    short epsPow{0}, sign{1}, numItera{0}, epsItera{0}, epsP10Itera{0}; // степень 1e-epsPow и знак.
    ...
    unsigned long long nFact{1}; // без знаковое - 8 байт (а почему-бы и нет?)
    ...
    cout << "Так, будьте добры ввести 3 числа через пробел," << endl 
         ...
         << "второе введённое вами число - это количество итераций (неотрицательное, < 15) которые выполнит цикл-счёта ряда." << endl
